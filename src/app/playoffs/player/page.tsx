...
import { columns } from "@/app/stats/player/columns";
...
async function getPlayerStatsPlayoffs(): Promise<OverallPlayerStatRecord[]> {
    const response = await fetch("/api/stats/players/playoffs", {
...
export default function StatPage() {
    ...
    React.useEffect(() => {
        getPlayerStatsPlayoffs().then((data) => setPlayerData(data));
    }, []);
        ...
        <div>
            <div className="container">
                <div className="flex justify-between">
                    <h1 className="text-3xl">Player Playoff Statistics</h1>
                    <DialogHeatmap
